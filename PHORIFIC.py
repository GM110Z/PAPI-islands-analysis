...
def write_results(output_file, operon_assignments):
    if not operon_assignments:
        ...
        return
# Convert the operon assignments to a DataFrame
    df = pd.DataFrame(operon_assignments)
...
if __name__ == "__main__":
    ...
    original_file_path = 'clusterRes_cluster.tsv'  # path to your original MMseqs clustering file
